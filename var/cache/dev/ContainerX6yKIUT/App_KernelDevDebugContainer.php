...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            include_once \dirname(__DIR__, 4).'/src/EventListener/CorsListener.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/nelmio/security-bundle/src/EventListener/KernelEventForwardCompatibilityTrait.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/nelmio/security-bundle/src/ContentSecurityPolicy/DirectiveSet.php';
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.response', [0 => #[\Closure(name: 'cors.response_listener', class: 'App\\EventListener\\CorsListener')] function () {
            return ($this->privates['cors.response_listener'] ??= new \App\EventListener\CorsListener());
        }, 1 => 'onKernelResponse'], 0);
        $instance->addListener('kernel.exception', [0 => #[\Closure(name: 'App\\EventListener\\ExceptionListener')] function () {
            return ($this->privates['App\\EventListener\\ExceptionListener'] ??= new \App\EventListener\ExceptionListener());
        }, 1 => 'onKernelException'], 200);
        $instance->addListener('lexik_jwt_authentication.on_authentication_failure', [0 => #[\Closure(name: 'App\\EventListener\\JWTResponseListener')] function () {
            return ($this->privates['App\\EventListener\\JWTResponseListener'] ??= new \App\EventListener\JWTResponseListener());
        }, 1 => 'onAuthenticationFailure'], 0);
        $instance->addListener('lexik_jwt_authentication.on_jwt_not_found', [0 => #[\Closure(name: 'App\\EventListener\\JWTResponseListener')] function () {
            return ($this->privates['App\\EventListener\\JWTResponseListener'] ??= new \App\EventListener\JWTResponseListener());
        }, 1 => 'onJwtNotFound'], 0);
        $instance->addListener('lexik_jwt_authentication.on_jwt_invalid', [0 => #[\Closure(name: 'App\\EventListener\\JWTResponseListener')] function () {
            return ($this->privates['App\\EventListener\\JWTResponseListener'] ??= new \App\EventListener\JWTResponseListener());
        }, 1 => 'onJwtInvalid'], 0);
        $instance->addListener('lexik_jwt_authentication.on_jwt_expired', [0 => #[\Closure(name: 'App\\EventListener\\JWTResponseListener')] function () {
            return ($this->privates['App\\EventListener\\JWTResponseListener'] ??= new \App\EventListener\JWTResponseListener());
        }, 1 => 'onJwtExpired'], 0);
        ...
        $instance->addListener('kernel.response', [0 => #[\Closure(name: 'nelmio_security.content_type_listener', class: 'Nelmio\\SecurityBundle\\EventListener\\ContentTypeListener')] function () {
            return ($this->privates['nelmio_security.content_type_listener'] ??= new \Nelmio\SecurityBundle\EventListener\ContentTypeListener(true));
        }, 1 => 'onKernelResponse'], 0);
        $instance->addListener('kernel.response', [0 => #[\Closure(name: 'nelmio_security.referrer_policy_listener', class: 'Nelmio\\SecurityBundle\\EventListener\\ReferrerPolicyListener')] function () {
        ...
        $instance->addListener('kernel.response', [0 => #[\Closure(name: 'nelmio_security.clickjacking_listener', class: 'Nelmio\\SecurityBundle\\EventListener\\ClickjackingListener')] function () {
            return ($this->privates['nelmio_security.clickjacking_listener'] ?? $this->getNelmioSecurity_ClickjackingListenerService());
        }, 1 => 'onKernelResponse'], 0);
        $instance->addListener('kernel.request', [0 => #[\Closure(name: 'nelmio_security.csp_listener', class: 'Nelmio\\SecurityBundle\\EventListener\\ContentSecurityPolicyListener')] function () {
            return ($this->privates['nelmio_security.csp_listener'] ?? $this->getNelmioSecurity_CspListenerService());
        }, 1 => 'onKernelRequest'], 512);
        $instance->addListener('kernel.response', [0 => #[\Closure(name: 'nelmio_security.csp_listener', class: 'Nelmio\\SecurityBundle\\EventListener\\ContentSecurityPolicyListener')] function () {
            return ($this->privates['nelmio_security.csp_listener'] ?? $this->getNelmioSecurity_CspListenerService());
        }, 1 => 'onKernelResponse'], 0);
        $instance->addListener('kernel.response', [0 => #[\Closure(name: 'nelmio_security.xss_protection_listener', class: 'Nelmio\\SecurityBundle\\EventListener\\XssProtectionListener')] function () {
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0oUVduJ1uD', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService()));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'lexik_jwt_authentication.user_id_claim' => 'login',
