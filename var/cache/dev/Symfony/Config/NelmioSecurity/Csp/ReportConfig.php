...
class ReportConfig 
{
     ...
     * @return \Symfony\Config\NelmioSecurity\Csp\Report\BrowserAdaptiveConfig|$this
     * @psalm-return (TValue is array ? \Symfony\Config\NelmioSecurity\Csp\Report\BrowserAdaptiveConfig : static)
     */
    public function browserAdaptive(array $value = []): \Symfony\Config\NelmioSecurity\Csp\Report\BrowserAdaptiveConfig|static
    {
        if (!\is_array($value)) {
        ...
        if (!$this->browserAdaptive instanceof \Symfony\Config\NelmioSecurity\Csp\Report\BrowserAdaptiveConfig) {
            $this->_usedProperties['browserAdaptive'] = true;
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('browser_adaptive', $value)) {
            $this->_usedProperties['browserAdaptive'] = true;
            $this->browserAdaptive = \is_array($value['browser_adaptive']) ? new \Symfony\Config\NelmioSecurity\Csp\Report\BrowserAdaptiveConfig($value['browser_adaptive']) : $value['browser_adaptive'];
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['browserAdaptive'])) {
            $output['browser_adaptive'] = $this->browserAdaptive instanceof \Symfony\Config\NelmioSecurity\Csp\Report\BrowserAdaptiveConfig ? $this->browserAdaptive->toArray() : $this->browserAdaptive;
        }
